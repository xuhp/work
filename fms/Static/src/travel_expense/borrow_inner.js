...
define(function (require, exports, module) {
    ...
    var borrow_inner = {
        ...
        //增加一行
        _add_row: function () {
            $('#borrow_addBtn').click(function () {
                var new_tr = borrow_new_row();
        ...
        _add_borrow_info: function () {
            $('#expenseBody').delegate('.sure_btn', 'click', function () {
                ...
                o_para.date=$tr.find('.jdpicker').val();
                o_para.money = no_comma($tr.find('.moneyBorrow').val());
                o_para.remark = $tr.find('.remark').val();
    ...
    function sure_change($tr, o_para) {
        ...
        flow_moneyBorrow.text($tr.find('.moneyBorrow').val());
