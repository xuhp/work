...
$(function () {
    if ($('.header').length > 0) {
        $('.header').append(createFrame());
    } else {
        $('body').append(createFrame());
    }
})
function createFrame() {
    return '<div id="calendarPanel" style="position:absolute;dispaly:none;z-index:9999;background-color:#FFFFFF;font-size:12px;width:0px;"><iframe id="calendarIframe" scrolling="no" frameborder="0" width="100%" height="100%"></iframe></div>';
}