...
; (function ($) {
    ...
    function e_resizer($elem) {
        var $parent = $elem.parent(),
 			$resizer = $parent.children('.ui_layout_resizer_east'),
            resizer_h = $resizer.height(),
            resizer_w = $resizer.width(),
 			mouse_down_client = {};
        $resizer.mousedown(function (e) {
    ...
    function create_layout_resizer_move($parent, offset, dir) {
        var $win = $(window),
            win_h = $(window).height(),
            win_w = $(window).width(),
 	        $resizer = $parent.children('.ui_layout_resizer_' + dir);
        var str = '<div class="ui_layout_resizer_mask" style="width:' + win_w + 'px;height:' + win_h + 'px;position:absolute;z-index:9;top:0;left:0;"></div>' +
            '<div class="ui_layout_resizer_move" style="position:absolute;z-index:99;height:' + $resizer.height() + 'px; width:' + $resizer.width() + 'px;left:' + offset.left + 'px ; top:' + offset.top + '; " >' +
 		'&nbsp;</div>';
        $parent.append(str);
